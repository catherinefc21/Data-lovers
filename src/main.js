...
<div class="welcome"><div class="textWelcome"><h2>Bienvenido(a)<br></h2><h3>¡Revisa nuestro menú y descubre todo sobre tus películas favoritas!</h3><br><br></div><img class="inicioImg"src="img/portada 3.png" alt=""></div>
</div>`
//BOTON HISTORIA
